...
function requestWeather() {
  ...
  function Weather() {
    ...
    // max amount of precipitation (in inches)
    this.getPrecipIntensityMax = function(range) {
      return range ? gatherRange(range, 'precipIntensityMax') : this.currently.precipIntensityMax;
    }
    ...
    this.getPrecipProbability = function(range) {
     ...
     // type of preciptation (rain, snow, sleet);
    this.getPrecipType = function(range) {
      return range ? gatherRange(range, 'precipType') : this.currently.precipType;
    }
